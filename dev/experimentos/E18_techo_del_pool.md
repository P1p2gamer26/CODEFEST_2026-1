...
`las notas del proyecto` cierra la seccion del reordenamiento con: *"ninguna estrategia que
...
`las notas del proyecto` propone la dispersion del top-12 como senal barata de "la consulta
